\subsection{LEMON\cite{lemon} (Explainable Entity Matching)}
...
moderately granular and use a limited number of samples, because LEMON requires substantial RAM.
In a complex example with $\texttt{granularity}=\texttt{"counterfactual"}$, the sample size was
set heuristically and required allocating $16.88$~GB of RAM.
