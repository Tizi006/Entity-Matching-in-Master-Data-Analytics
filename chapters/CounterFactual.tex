...
The counterfactual explanation method is implemented on top of our previosly defined balack box model. 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{images/field_heatmap_200.png}
    \caption{Heatmap of token perturbation frequencies across different record attributes.}
