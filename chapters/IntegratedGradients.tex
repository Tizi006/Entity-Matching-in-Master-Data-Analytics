...
The input to the model consists of paired attribute columns for two entities, specifically \texttt{authors\_1}, \texttt{authors\_2}, \texttt{title\_1}, \texttt{title\_2}, \texttt{venue\_1}, \texttt{venue\_2}, \texttt{year\_1}, and \texttt{year\_2}. For transparency, the example shown in Figure~\ref{fig:igplot} corresponds to the following entity pair:
